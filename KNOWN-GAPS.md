...
| Production offline map source and license | Use the delivered `TEST_ONLY` pack (`map-pack/gate0-lacrosse-v1.pmtiles`); production provider/license remain undecided | Floodcaster/product/legal |
