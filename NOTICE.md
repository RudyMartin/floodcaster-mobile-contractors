...
Do not add credentials, customer data, non-public datasets, internal operational evidence, production configuration, or proprietary backend source. Before implementation or contractor work product is added, repository visibility must be changed to private and access must be limited to authorized participants.
